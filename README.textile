...
!images/integration_spree/spree.jpg(Spree)!
...
!images/integration_spree/spree_front.png(Loja no ar)! 
...
!images/integration_spree/extension_files.png(Arquivos da extensão)!
...
!images/integration_spree/cadastro.png(Cadastro no Mailee)!

!images/integration_spree/mailee_dashboard.png(Cadastro realizado com sucesso)!
...
!images/integration_spree/mailee_integrar.png(Integrar)!

!images/integration_spree/mailee_rest.png(REST)!
...
!images/integration_spree/mailee_active_contacts.png(Contatos ativos)!
...
!images/integration_spree/mailee_inactive_contacts.png(Contatos inativos)!
...
!images/integration_spree/novo_usuario.png(Cadastro de usuário)!
...
!images/integration_spree/mailee_contact_found_index.png(Contato na lista do Mailee)!

!images/integration_spree/mailee_contact_found_index.png(Visualização do contato no Mailee)!
...
!images/integration_spree/coffee-shaking.jpg(Café demais faz mal)!
